...
TL45TargetLowering::TL45TargetLowering(const TL45TargetMachine &TM,
  ...
  unsigned int Ops[] = {ISD::BSWAP, ISD::CTTZ, ISD::CTLZ, ISD::CTPOP,
                        ISD::BITREVERSE};
...
SDValue TL45TargetLowering::lowerGlobalAddress(SDValue Op,
  ...
  SDValue root = DAG.getNode(ISD::ADD, DL, MVT::i32, Addr,
                             DAG.getConstant(Offset, DL, MVT::i32));

  return root;
}

SDValue TL45TargetLowering::ExpandLibCall(const char *LibcallName, SDValue Op,
                                          bool isSigned,
                                          SelectionDAG &DAG) const {
...
bool TL45TargetLowering::canMergeStoresTo(unsigned AS, EVT MemVT,
