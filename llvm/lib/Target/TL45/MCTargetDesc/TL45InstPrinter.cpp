...
void TL45InstPrinter::printInst(const MCInst *MI, uint64_t Address, StringRef Annot,
...
void TL45InstPrinter::printCondCode(const MCInst *MI, unsigned OpNum,
                                    raw_ostream &O) {
}

void TL45InstPrinter::printAddrModeMemSrc(const MCInst *MI, unsigned OpNum,
                                          raw_ostream &O) {

}

void
TL45InstPrinter::printMemOperand(const MCInst *MI, int opNum, raw_ostream &O) {
